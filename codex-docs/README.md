...
This project is a pre-configured setup of [codex docs](https://github.com/codex-team/codex.docs), which is a documentation system developed by the [editorjs team](https://editorjs.io/).
...
then head to [http://localhost:5005](http://localhost:5005)

## Security

Please change the password, it is set in `.env` and is **not secure**!

Below are the official docs from this repo!
